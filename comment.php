        ...
        <div class="card mb-3">
            <div class="row g-0">
                ...
                <div class="card-body">
                    ...
                    <div class="p-2">
                    <form action="">
                        <textarea name="" placeholder="Tuliskan komentar Anda disini" id="" class="form-control"></textarea>
                        <button type="submit" class="btn btn-outline-primary mt-2">Kirim Komentar</button>
                    </form>
                    </div>
